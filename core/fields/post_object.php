...
class acf_field_post_object extends acf_field
{
	...
	*/
	...
	function create_field( $field )
	{
		...
		if( in_array('all', $field['post_type']) && !in_array(ACF_NONE_VALUE,$field['post_type']) )
		{
			...
			foreach( $field['post_type'] as $post_type )
			{
				...
				if (isset($field['is_page_link']) && $field['is_page_link'])
				{
					if (get_post_type_archive_link($post_type)) {
						...
						else $field['choices'][ $post_type_name ][ 'ptarchive:' . $post_type ] = __('Archive','acf');
					}
				}
		...
		if (isset($field['is_page_link']) && $field['is_page_link'])
		{
			...
			if( in_array('all',$field['taxonomies']) && !in_array(ACF_NONE_VALUE,$field['taxonomies'])) 
			{
